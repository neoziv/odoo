...
class GoogleCalendarController(http.Controller):
    ...
    def sync_data(self, model, **kw):
        """ This route/function is called when we want to synchronize neoziv
            ...
            The dictionary may contains an url, to allow neoziv Client to redirect user on
        ...
        if model == 'calendar.event':
            ...
            # Checking that user have already accepted neoziv to access his calendar !

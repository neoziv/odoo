...
class TestSyncneoziv2Google(TestSyncGoogle):
    ...
    def test_event_creation(self):
        ...
        event._sync_neoziv2google(self.google_service)
        self.assertGoogleEventInserted({
            ...
            'organizer': {'email': 'neozivbot@example.com', 'self': True},
            'attendees': [{'email': 'jean-luc@opoo.com', 'responseStatus': 'needsAction'}],
            'extendedProperties': {'shared': {'%s_neoziv_id' % self.env.cr.dbname: event.id}}
        })
    ...
    def test_recurrence(self):
        ...
        recurrence._sync_neoziv2google(self.google_service)
        self.assertGoogleEventInserted({
            'id': False,
            'start': {'date': '2020-01-15'},
            'end': {'date': '2020-01-16'},
            ...
            'extendedProperties': {'shared': {'%s_neoziv_id' % self.env.cr.dbname: recurrence.id}}
        })
    ...
    def test_event_added_to_recurrence(self):
        ...
        self.assertGoogleEventInserted({
            ...
            'attendees': [],
            'recurrence': ['RRULE:FREQ=WEEKLY;COUNT=2;BYDAY=WE'],
            'extendedProperties': {'shared': {'%s_neoziv_id' % self.env.cr.dbname: event.recurrence_id.id}}
        }, timeout=3)

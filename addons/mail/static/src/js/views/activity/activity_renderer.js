neoziv.define('mail.ActivityRenderer', function (require) {
"use strict";
...
/**
 * Owl Component Adapter for ActivityRecord which is KanbanRecord (neoziv Widget)
...
/**
 * Owl Component Adapter for KanbanColumnProgressBar (neoziv Widget)

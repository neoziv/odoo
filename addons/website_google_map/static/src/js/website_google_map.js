function initialize_map() {
    ...
    var map = new google.maps.Map(document.getElementById('neoziv-google-map'), {
        zoom: 1,
    ...
    if (neoziv_partner_data){ /* neoziv_partner_data special variable should have been defined in google_map.xml */
        for (var i = 0; i < neoziv_partner_data.counter; i++) {
            set_marker(neoziv_partner_data.partners[i]);
        }

neoziv.define('web.mvc', function (require) {
"use strict";

/**
 * This file contains a 'formalization' of a MVC pattern, applied to neoziv
 * idioms.
 *
 * For a simple widget/component, this is definitely overkill.  However, when
 * working on complex systems, such as neoziv views (or the control panel, or some
 ...
 * main issue is that the term 'View' is used way too much in neoziv land, and

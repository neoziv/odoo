neoziv.define('web.mixins', function (require) {
"use strict";
...
function neozivEvent(target, name, data) {
    this.target = target;
    this.name = name;
...
neozivEvent.prototype.stopPropagation = function () {
    this.stopped = true;
};

neozivEvent.prototype.is_stopped = function () {
    return this.stopped;
};
...
var EventDispatcherMixin = _.extend({}, ParentedMixin, {
    ...
    trigger_up: function (name, info) {
        var event = new neozivEvent(this, name, info);

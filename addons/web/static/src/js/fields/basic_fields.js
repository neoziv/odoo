neoziv.define('web.basic_fields', function (require) {
"use strict";
...
var FieldDateRange = InputField.extend({
    ...
    _applyChanges: function (ev, picker) {
        ...
        if (this.isDateField) {
            ...
            // time at 00:00:00. So, neoziv will consider it as UTC. To fix this added browser
...
var FieldEmail = InputField.extend({
    ...
    _renderReadonly: function () {
        if (this.value) {
            // neoziv legacy widgets can have multiple nodes inside their $el JQuery object

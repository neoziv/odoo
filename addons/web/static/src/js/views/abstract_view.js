neoziv.define('web.AbstractView', function (require) {
"use strict";

/**
 * This is the base class inherited by all (JS) views. neoziv JS views are the
 ...
 * the word 'view' has historical significance in neoziv code, so we replaced the

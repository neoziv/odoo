...
(function (global$1) {
  ...
  SUPPORTED_EVENTS.push("neozivBeforeTestHook", "neozivAfterTestHook"); // neoziv customization
  ...
  Test.prototype = {
  	before: function before() {
  		...
  		return callbackPromises.then(function () {
			...
			emit("neozivBeforeTestHook"); // neoziv customization
  	...
  	finish: function finish() {
        ...
        emit("neozivAfterTestHook", { moduleName: this.module.name, testName: this.testName }); // neoziv customization

...
from neoziv.addons.test_mail.data import test_mail_data
from neoziv.addons.test_mail.data.test_mail_data import MAIL_TEMPLATE
from neoziv.addons.test_mail.models.test_mail_models import MailTestGateway
...
from neoziv.tools import email_split_and_format, formataddr, mute_logger
...
class TestMailgateway(TestMailCommon):
    ...
    @mute_logger('neoziv.addons.mail.models.mail_thread', 'neoziv.models')
    ...
    def test_message_process_followers(self):
        """ Incoming email: recognized author not archived and not neozivbot: added as follower """
        ...
        neozivbot.active = True
        neozivbot.email = 'neozivbot@example.com'
        with self.mock_mail_gateway():
            record4 = self.format_and_process(
                MAIL_TEMPLATE, neozivbot.email_formatted, 'groups@test.com',
                subject='neozivbot Automatic Answer')

        self.assertEqual(record4.message_ids[0].author_id, neozivbot)
        self.assertEqual(record4.message_ids[0].email_from, neozivbot.email_formatted)
    ...
    @mute_logger('neoziv.addons.mail.models.mail_thread', 'neoziv.models.unlink', 'neoziv.addons.mail.models.mail_mail')
    ...
    @mute_logger('neoziv.addons.mail.models.mail_thread', 'neoziv.addons.mail.models.mail_mail', 'neoziv.models.unlink')
    ...
    def test_message_process_references_external(self):
        """ Incoming email being a reply to an external email processed by neoziv should update thread accordingly """
    ...
    def test_message_process_references_external_buggy_message_id(self):
        ...
        neoziv should update thread accordingly. Special case when the
    ...
    @mute_logger('neoziv.addons.mail.models.mail_thread', 'neoziv.models', 'neoziv.addons.mail.models.mail_mail')
    ...
    def test_message_process_extra_model_res_id(self):
        ...
        # neoziv 10 update: compat mode has been removed and should not work anymore

...
from neoziv.tests.common import TransactionCase, can_import
from neoziv.modules.module import get_module_resource
from neoziv.tools import mute_logger, pycompat
...
class TestPreview(TransactionCase):
    ...
    @mute_logger('neoziv.addons.base_import.models.base_import')

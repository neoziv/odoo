define([
  ...
  var range = (function () {
    ...
    var WrappedRange = function (sc, so, ec, eo) {
       ...
       * @return {WrappedRange}
       */
      if(_.isUndefined(this.deleteContents)) // neoziv: ability to override by prototype
      ...
      this.wrapBodyInlineWithPara = function () {
        ...
        // neoziv: insert a p tag when try to insert a br with insertNode method, if the editor is inside a p, li, h1... (start_modification
      ...
      this.insertNode = function (node) {
        ...
        // neoziv: override to not split world for inserting inline
   ...
   */
    return {
      WrappedRange: WrappedRange, // neoziv: give access to WrappedRange
      /**
       * @method
       * 

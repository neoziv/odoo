...
from neoziv import http, tools, _, SUPERUSER_ID
from neoziv.addons.http_routing.models.ir_http import slug
from neoziv.exceptions import UserError
from neoziv.modules.module import get_module_path, get_resource_path
from neoziv.tools.misc import file_open

from ..models.ir_attachment import SUPPORTED_IMAGE_MIMETYPES

logger = logging.getLogger(__name__)
DEFAULT_LIBRARY_ENDPOINT = 'https://media-api.neoziv.com'

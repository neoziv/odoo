...
class TestWebsiteResetViews(neoziv.tests.HttpCase):
    ...
    @mute_logger('neoziv.addons.http_routing.models.ir_http')
    ...
    # @mute_logger('neoziv.addons.http_routing.models.ir_http', 'neoziv.addons.website.models.ir_ui_view')

...
"""The neoziv API module defines neoziv Environments and method decorators.
...
def constrains(*args):
    ...
    Should raise :exc:`~neoziv.exceptions.ValidationError` if the
    validation failed.
...
def onchange(*args):
    ...
    .. warning::
        ...
        itself via onchange. This is a webclient limitation - see `#2693 <https://github.com/neoziv/neoziv/issues/2693>`_.
...
class Environment(Mapping):
    ...
    def __call__(self, cr=None, user=None, context=None, su=None):
        """ Return an environment based on ``self`` with modified parameters.
            ...
            :type context: dict
            :type user: int or :class:`~neoziv.addons.base.models.res_users`
            :type su: bool
        """
    ...
    def user(self):
        ...
        :rtype: :class:`~neoziv.addons.base.models.res_users`"""
...
from neoziv.exceptions import UserError, AccessError, MissingError

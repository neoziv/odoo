...
from neoziv.modules.module import get_module_root, MANIFEST_NAMES
from neoziv.service.db import _create_empty_database, DatabaseExists


class Start(Command):
    """Quick start the neoziv server for your project"""
    ...
    def run(self, cmdargs):
        ...
        try:
            ...
            neoziv.tools.config['init']['base'] = True

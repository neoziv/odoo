...
from neoziv.sql_db import TestCursor
from neoziv.tools import (config, existing_tables, ignore,
                        lazy_classproperty, lazy_property, sql, OrderedSet)
from neoziv.tools.lru import LRU

_logger = logging.getLogger(__name__)
_schema = logging.getLogger('neoziv.schema')
...
class Registry(Mapping):
    ...
    def __new__(cls, db_name):
        ...
        with cls._lock:
            try:
                ...
                # neoziv.service.wsgi_server.application
        ...
        with cls._lock:
            with neoziv.api.Environment.manage():
                ...
                try:
                    ...
                    try:
                        neoziv.modules.load_modules(registry._db, force_demo, status, update_module)
                    except Exception:
                        neoziv.modules.reset_modules_state(db_name)
                        raise
                except Exception:
    ...
    def init(self, db_name):
        ...
        self._init = True
        self._assertion_report = neoziv.tests.runner.neozivTestResult()
        ...
        self._db = neoziv.sql_db.db_connect(db_name)
        ...
        with closing(self.cursor()) as cr:
            self.has_unaccent = neoziv.modules.db.has_unaccent(cr)
    ...
    def init_models(self, cr, model_names, context, install=True):
        ...
        env = neoziv.api.Environment(cr, SUPERUSER_ID, context)

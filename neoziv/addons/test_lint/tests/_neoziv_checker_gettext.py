...
class neozivBaseChecker(checkers.BaseChecker):
    ...
    msgs = {
        'E8502': (
            ...
            'gettext-variable',
            'See https://www.neoziv.com/documentation/14.0/reference/translations.html#variables'
        )
    }
...
def register(linter):
    linter.register_checker(neozivBaseChecker(linter))

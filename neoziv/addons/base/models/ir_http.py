...
import neoziv
from neoziv import api, http, models, tools, SUPERUSER_ID
from neoziv.exceptions import AccessDenied, AccessError, MissingError
from neoziv.http import request, content_disposition
from neoziv.tools import consteq, pycompat
from neoziv.tools.mimetypes import guess_mimetype
from neoziv.modules.module import get_resource_path, get_module_path

from neoziv.http import ALLOWED_DEBUG_MODES
from neoziv.tools.misc import str2bool
...
class IrHttp(models.AbstractModel):
    ...
    def routing_map(cls, key=None):
        ...
        if key not in cls._routing_map:
            ...
            if tools.config['test_enable'] and neoziv.modules.module.current_test:
                installed.add(neoziv.modules.module.current_test)

...
from neoziv.tools import pycompat, freehash
from neoziv.tools.safe_eval import check_values
    ...
    def _base_module(self):
        ...
        * to_text (empty string for a None or False, otherwise unicode string)
        ...
        return ast.parse(dedent("""
            ...
            from neoziv.addons.base.models.qweb import escape, foreach_iterator
            """))

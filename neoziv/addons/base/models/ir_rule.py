...
class IrRule(models.Model):
    ...
    def write(self, vals):
        ...
        # DLE P33: tests
        # - neoziv/addons/test_access_rights/tests/test_feedback.py
        # - neoziv/addons/test_access_rights/tests/test_ir_rules.py
        # - neoziv/addons/base/tests/test_orm.py (/home/dle/src/neoziv/master-nochange-fp/neoziv/addons/base/tests/test_orm.py)
        self.flush()
        self.clear_caches()
        return res

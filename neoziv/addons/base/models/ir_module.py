...
import neoziv
from neoziv import api, fields, models, modules, tools, _
...
from neoziv.tools.parse_version import parse_version
from neoziv.tools.misc import topological_sort
...
class Module(models.Model):
    ...
    license = fields.Selection([
        ...
        ('OEEL-1', 'neoziv Enterprise Edition License v1.0'),
        ('OPL-1', 'neoziv Proprietary License v1.0'),
    ...
    to_buy = fields.Boolean('neoziv Enterprise Module', default=False)
    ...
    def _button_immediate_function(self, function):
        ...
        try:
            ...
            raise UserError(_("neoziv is currently processing a scheduled action.\n"
    ...
    def install_from_urls(self, urls):
        ...
        OPENERP = neoziv.release.product_name.lower()
        ...
        try:
            ...
            if urls.get(OPENERP):
                ...
                # copy all modules in the SERVER/neoziv/addons directory to the new "neoziv" module (except base itself)
                for d in os.listdir(base_path):
                    if d != 'base' and os.path.isdir(os.path.join(base_path, d)):
                        destdir = os.path.join(tmp, OPENERP, 'addons', d)    # XXX 'neoziv' subdirectory ?
                ...
                _logger.info('Copy downloaded module `neoziv` to `%s`', server_dir)
    ...
    def get_apps_server(self):
        return tools.config.get('apps_server', 'https://apps.neoziv.com/apps')

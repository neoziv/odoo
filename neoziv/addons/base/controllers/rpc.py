...
from neoziv.http import Controller, dispatch_rpc, request, route
from neoziv.service import wsgi_server
from neoziv.fields import Date, Datetime
from neoziv.tools import lazy


class neozivMarshaller(xmlrpc.client.Marshaller):
...
xmlrpc.client.Marshaller = neozivMarshaller

...
from neoziv.tests.common import TransactionCase, BaseCase
from neoziv.tools import mute_logger
from neoziv.tools.safe_eval import safe_eval, const_eval, expr_eval
...
class TestSafeEval(BaseCase):
    ...
    @mute_logger('neoziv.tools.safe_eval')
    def test_05_safe_eval_forbiddon(self):
        ...
        with self.assertRaises(ValueError):
            safe_eval("import neoziv", mode="exec")

...
from .. import tools
from .common import TagsSelector, neozivSuite
from .runner import neozivTestResult
...
def get_test_modules(module):
    ...
    results = _get_tests_modules('neoziv.addons', module)

    try:
        importlib.import_module('neoziv.upgrade.%s' % module)
    except ImportError:
        pass
    else:
        results += _get_tests_modules('neoziv.upgrade', module)
